...
const DepartmentTable = () => {
    const { departments, removeDepartment, updateDepartment} = useDepartment();
    ...
    const editDepartment = (id: number, departmentName: string) => {
        Swal.fire({
            showConfirmButton: false,
            ...
            html: `
                          <div class="flex flex-col gap-3">
                            <input id="department" value="${departmentName}"
                        ...
                        <tr key={item.departmentID} className="hover:bg-white/5 transition-colors" style={{ fontFamily: "Noto Sans Lao" }}>
                            ...
                            <td className="px-6 py-4 font-lao">
                                <div className="flex gap-1">
                                    <button 
                                     onClick={()=>editDepartment(item.departmentID, item.departmentName)}
